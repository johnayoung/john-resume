...
description: "A verified, growing index of the primary research behind engineering practices for AI coding agents — every entry a verbatim figure or quote, checked against its source."
...
For the argument this evidence adds up to, read [**The State of AI Coding Agent Engineering**](/state-of-ai-coding-agent-engineering/) — the synthesis across all six themes, free by email.
